                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-12 col-lg-8">
                            <div class="short_contact_list">
                                <ul>
                                    ...
                                    <li><a href="mailto:leshautesbornes.choisyleroi@gmail.com?subject=Let's%20work%20together!"> <i class="fa fa-envelope"></i>leshautesbornes.choisyleroi@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6 col-lg-4">
                            <div class="social_media_links d-none d-lg-block">
                                ...
                                <a href="https://www.facebook.com/groups/leshautesbornes/">
                                    <i class="fa fa-facebook"></i>
                                </a>
                                <a href="https://www.youtube.com/channel/UChqQZLsbzK9K7MtUIbIV6kQ/featured">
                                    ...
                                    <ul id="navigation">
                                        ...
                                        <li><a href="#">Activités <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                ...
                                                <li><a href="blog.html">Jardin-partager</a></li>
                                                <li><a href="single-blog.html">Astronomie</a></li>
                                                <li><a href="single-blog.html">Planétarium</a></li>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            ...
                            <p class="address_text">Les résidents des Hautes-Bornes, <br> Les résidents des Hautes-Bornes <br> Les résidents des Hautes-Bornes.
                            </p>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <div class="contacts">
                                <p>+33 6 26 38 25 12 <br>
                                leshautesbornes.choisyleroi@gmail.com <br>
                                    13 Rue de la Remise aux Faisans, 94600 Choisy-le-Roi
                                </p>
                            </div>
                        </div>
                    </div>
